...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam) {
	...
	static pfnMakeSquare pfn = NULL;
	switch (iMsg) {
	case WM_CREATE:
		hLib = LoadLibrary(TEXT("SquareDLL_Def.dll"));
		if (hLib == NULL) {
			MessageBox(hwnd, TEXT("Required DLL cannot be loaded"), TEXT("ERROR"), MB_OK | MB_ICONSTOP | MB_TOPMOST);
			DestroyWindow(hwnd);
		}
