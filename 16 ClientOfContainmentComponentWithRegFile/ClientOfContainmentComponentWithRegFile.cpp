...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam) {
	...
	case WM_CREATE:
		...
		hr = pISum->QueryInterface(IID_ISubstract,(void **)&pISubract);
		if (FAILED(hr)) {
		...
		iNum1 = 155;
		iNum2 = 55;
		pISubract->SubstractionOfTwoIntegers(iNum1, iNum2, &iSubtraction);
		...
		hr = pIMultiplication->QueryInterface(IID_IDivison, (void **)&pIDivision);
		if (FAILED(hr)) {
